    ...
    <TabGroup v-slot="{ selectedIndex }" vertical>
      <div class="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          ...
          >
            <!-- Left content -->
            <div class="shrink-0 md:w-[500px] *:pl-7">
              <div
              ...
              >
                ...
                <TabList class="space-y-2">
                  <Tab :key="index" v-for="(tab, index) in tabs" as="template">
                    <button
                      class="ui-focus-visible:outline-none ui-focus-visible:ring ui-focus-visible:ring-indigo-300 -mx-2 flex gap-2 p-2 text-left transition-opacity focus-visible:outline-hidden"
                      :class="
                        selectedIndex !== index
